...
amount_markup_btn1 =  types.KeyboardButton('Забронировать игру')
amount_markup_btn1 =  types.KeyboardButton('Посмореть цены')
amount_markup_btn1 =  types.KeyboardButton('Вернуться в каталог игр')
amount_markup.add(game_markup_btn1, game_markup_btn2, game_markup_btn3)
